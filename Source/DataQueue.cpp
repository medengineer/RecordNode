...
void DataQueue::writeChannel(const AudioSampleBuffer& buffer, int channel, int nSamples)
{
	...
	{
		lastIdx = index1;
		printf("Idx1: %d, Size1: %d, Idx2: %d, Size2 %d\n", index1, size1, index2, size2); fflush(stdout);
	}
